...
PROTO_IMPORTS = [
    (
        ...
        "tensorbored.compat.proto.allocation_description_pb2",
    ),
    (
        "tensorflow.core.framework.api_def_pb2",
        "tensorbored.compat.proto.api_def_pb2",
    ),
    (
        "tensorflow.core.framework.attr_value_pb2",
        "tensorbored.compat.proto.attr_value_pb2",
    ),
    (
        "tensorflow.core.protobuf.cluster_pb2",
        "tensorbored.compat.proto.cluster_pb2",
    ),
    (
        "tensorflow.core.protobuf.config_pb2",
        "tensorbored.compat.proto.config_pb2",
    ),
    (
        "tensorflow.core.framework.cost_graph_pb2",
        "tensorbored.compat.proto.cost_graph_pb2",
    ),
    (
        "tensorflow.python.framework.cpp_shape_inference_pb2",
        "tensorbored.compat.proto.cpp_shape_inference_pb2",
    ),
    (
        "tensorflow.core.protobuf.debug_pb2",
        "tensorbored.compat.proto.debug_pb2",
    ),
    ("tensorflow.core.util.event_pb2", "tensorbored.compat.proto.event_pb2"),
    (
        "tensorflow.core.framework.function_pb2",
        "tensorbored.compat.proto.function_pb2",
    ),
    (
        "tensorflow.core.framework.graph_debug_info_pb2",
        "tensorbored.compat.proto.graph_debug_info_pb2",
    ),
    (
        "tensorflow.core.framework.graph_pb2",
        "tensorbored.compat.proto.graph_pb2",
    ),
    (
        "tensorflow.core.protobuf.meta_graph_pb2",
        "tensorbored.compat.proto.meta_graph_pb2",
    ),
    (
        "tensorflow.core.framework.node_def_pb2",
        "tensorbored.compat.proto.node_def_pb2",
    ),
    (
        "tensorflow.core.framework.op_def_pb2",
        "tensorbored.compat.proto.op_def_pb2",
    ),
    (
        "tensorflow.core.framework.resource_handle_pb2",
        "tensorbored.compat.proto.resource_handle_pb2",
    ),
    (
        "tensorflow.core.protobuf.rewriter_config_pb2",
        "tensorbored.compat.proto.rewriter_config_pb2",
    ),
    (
        "tensorflow.core.protobuf.saved_object_graph_pb2",
        "tensorbored.compat.proto.saved_object_graph_pb2",
    ),
    (
        "tensorflow.core.protobuf.saver_pb2",
        "tensorbored.compat.proto.saver_pb2",
    ),
    (
        "tensorflow.core.framework.step_stats_pb2",
        "tensorbored.compat.proto.step_stats_pb2",
    ),
    (
        "tensorflow.core.protobuf.struct_pb2",
        "tensorbored.compat.proto.struct_pb2",
    ),
    (
        "tensorflow.core.framework.summary_pb2",
        "tensorbored.compat.proto.summary_pb2",
    ),
    (
        "tensorflow.core.framework.tensor_pb2",
        "tensorbored.compat.proto.tensor_pb2",
    ),
    (
        "tensorflow.core.framework.tensor_description_pb2",
        "tensorbored.compat.proto.tensor_description_pb2",
    ),
    (
        "tensorflow.core.framework.tensor_shape_pb2",
        "tensorbored.compat.proto.tensor_shape_pb2",
    ),
    (
        "tensorflow.core.profiler.tfprof_log_pb2",
        "tensorbored.compat.proto.tfprof_log_pb2",
    ),
    (
        "tensorflow.core.protobuf.trackable_object_graph_pb2",
        "tensorbored.compat.proto.trackable_object_graph_pb2",
    ),
    (
        "tensorflow.core.framework.types_pb2",
        "tensorbored.compat.proto.types_pb2",
    ),
    (
        "tensorflow.core.framework.variable_pb2",
        "tensorbored.compat.proto.variable_pb2",
    ),
    (
        "tensorflow.core.framework.versions_pb2",
        "tensorbored.compat.proto.versions_pb2",
    ),
]
...
5. Verify that this test now passes. Ensure that the target version of TF from
   step 1 is the version in your virtual environment, and then run:
    ...
    bazel test //tensorbored/compat/proto:proto_test
