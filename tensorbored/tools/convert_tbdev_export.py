...
open source TensorBoard as a log directory, as follows:
    ...
    $ tensorbored --logdir <OUT-DIRECTORY>
...
try:
    import tensorbored  # noqa: F401
except ImportError:
    logging.error(
        "Could not import tensorbored. Please pip install tensorbored"
    )
    exit(1)

from tensorbored.compat.proto.event_pb2 import Event
