...
from tensorbored.summary.writer.event_file_writer import _AsyncWriter
from tensorbored.compat.proto import event_pb2
from tensorbored.compat.proto.summary_pb2 import Summary
from tensorbored.compat.tensorflow_stub.pywrap_tensorflow import (
    PyRecordReader_New,
)
...
class EventFileWriterTest(tb_test.TestCase):
    ...
    def test_async_writer_without_write(self):
        ...
        self.assertEqual(
            ...
            "tensorbored.summary.writer.event_file_writer",
        )
